...
public class Util {
    ...
    public static boolean isRelatedPage(String url) {
        return url.startsWith("http://starwars.wikia.com/wiki/") && !url.contains("javascript:") &&
                !url.contains("mailto:") && !url.contains("@")
                && !url.contains("action=edit") && !url.matches("(.*)jpg$")
                && !url.matches("(.*)png$");
